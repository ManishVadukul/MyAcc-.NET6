...
namespace MyAcc.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        {
            ReturnUrl = returnUrl;
            //below added by Manish
            var resultCompanylist =  _company.GetAll();
            var resultRolelist =  _company.GetAll();

            Input = new InputModel()
            {              

                CompanyList = resultCompanylist.Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                }),
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //below user properties added by Manish
                ...
                if (result.Succeeded)
                {
                    ...
                    //below email code commented by Manish
